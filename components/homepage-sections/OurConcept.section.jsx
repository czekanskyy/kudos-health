...
const OurConceptSection = () => {
  return (
    <section id='our-concept' className='mt-64 p-4 text-slate-500 flex flex-col gap-16'>
      ...
      <OurConceptCard title='Inclusivity' image={HandsImage} alt='A group of people put their hands one on top of the other'>
      ...
      <OurConceptCard title='Innovation' image={IdeaImage} alt='Light bulb shines on a wall filled with different ideas' imgRight={true}>
      ...
      <OurConceptCard title='Integration' image={FitImage} alt='Woman checks workout stats on smartwatch'>
